    ...
    <div class="app-container">
        <el-container>
            <el-main>
                ...
                <!--新建电源线-->
                <el-button style="background-color: #006EFF;color: #fff;float: right ; margin-bottom: 15px;" @click="newOpenpowerLine = true  ">新建电源线</el-button>
        ...
        <el-dialog title="新建电源线" :visible.sync="newOpenpowerLine" :modal-append-to-body="false" width="25%" center >
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click="newOpenpowerLine = false">确 定</el-button>
